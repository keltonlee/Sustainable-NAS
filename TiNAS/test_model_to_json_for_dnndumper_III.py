...
def dump_for_model_config(global_settings, subnet_config, subnet_config_name):
    ...
    subnet_latency_info, carbon, inference_per_lifetime = performance_model.get_carbon_info(subnet_obj, subnet_config)
    ...
    print(f'Solution carbon footprint and inference per lifetime: {carbon}, {inference_per_lifetime}')
