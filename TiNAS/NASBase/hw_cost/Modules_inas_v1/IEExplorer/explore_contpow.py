                ...
                for Tn in tn_lst:
                    ...
                    for inter_lo in inter_tile_order:                        
                        #print (R, C, M, N, Tr, Tc, Tm, Tn, inter_lo)
                            ...
                            ###
                            if (res_cons_c0[0]):
                                #lay_E, lay_L, lay_T_cpu, lay_T_mem, lay_T_disk, cost_breakdown = cnn.est_cost_layer_contpow(layer, params_exec, plat_settings, plat_cost_profile); common.check_infnan([lay_E, lay_L])      
                                ...
                                result_pass.append({
                                        ...
                                        #'T_cpu':  lay_T_cpu, 'T_mem':  lay_T_mem, 'T_disk':  lay_T_disk, 
...
def get_le2e_fixed_params_contpow(layer, params_exec, params_pres, plat_settings, plat_cost_profile):
    ...
    if (res_cons_c0[0]):
        #lay_E, lay_L, lay_T_cpu, lay_T_mem, lay_T_disk, cost_breakdown = cnn.est_cost_layer_contpow(layer, params_exec, plat_settings, plat_cost_profile)
        ...
        result = {
                ...
                #'T_cpu':  None, 'T_mem':  None, 'T_disk':  None,
                'npc' : [None, None, None],
                'L_rc_tot': None,
                'cost_brk': None,
                'vm' : res_cons_c0[2]
