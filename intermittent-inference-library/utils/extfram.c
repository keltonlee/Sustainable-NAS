...
// 0000000006825160 - CY15B116QSN-108BKXI
// https://www.infineon.com/dgdl/Infineon-CY15B116QSN-108BKXIE-DataSheet-v06_00-EN.pdf?fileId=8ac78c8c7d0d8da4017d0eea5be97353, Section 18 Ordering information
#define DEVICE_ID_LENGTH 8
const char deviceid_p[DEVICE_ID_LENGTH] = {0x60,0x51,0x82,0x06,0x00,0x00,0x00,0x00};

#elif defined(FRAM_8Mb)

// 7F7F7F7F7F7FC22FA1 - CY15B108QI-20LPXC or CY15B108QI-20LPXCT [1]
// https://www.infineon.com/dgdl/Infineon-CY15B108QI_CY15V108QI_8Mb_EXCELON_LP_Ferroelectric_RAM_F-RAM_Serial_SPI_1024K_8_inrush_current_control_industrial-DataSheet-v17_00-EN.pdf?fileId=8ac78c8c7d0d8da4017d0ee73ee37021, Section 14 Ordering informatio
#define DEVICE_ID_LENGTH 9
const char deviceid_p[DEVICE_ID_LENGTH] = {0xA1,0x2F,0xC2,0x7F,0x7F,0x7F,0x7F,0x7F,0x7F};

#else

// TODO: put 4Mb FRAM device ID here

#endif

int _FRAM_rdy(){
	// Not testing FRAM by readin/writing data, as that will break preserved progress indicators
	// return testSPI();
...
void eraseFRAM(){
	uint8_t val;
	unsigned long cnt = EXTFRAM_SIZE - 1;
