...
* model-intpow.h 
* (Auto-generated)
* Created on: 02/07/24,21:36:51 
* Label : MODEL_INTPOW 
*/

#ifndef MODEL_INTPOW_H_
#define MODEL_INTPOW_H_
...
#pragma PERSISTENT(MODEL_INTPOW)
CNNLayer_t MODEL_INTPOW[72] = {
{
	// CONV_0 (stem.conv0)
	.lix = 0,
...
},
{
	// BN_1 (stem.bn0)
	.lix = 1,
	.fun = CNN_Intermittent_BatchNormalization,
	.repeat = 32,
	.weights = (Mat_t){
		.data = 295876,
		.n = 4,
...
},
{
	...
	.lix = 5,
	.fun = CNN_Intermittent_LayerConv_Tiled_Depthwise,
	.repeat = 2,
	.weights = (Mat_t){
		.data = 297924,
		.n = 48,
